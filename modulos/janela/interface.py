...
class Interface:
    ...
    def _criar_painel(self, root, ao_mudar_ferramenta, ao_mudar_borda, ao_mudar_preenchimento):
        ...
        for texto, chave in [("Retângulo", "retangulo"), ("Oval", "oval"), ("Círculo", "circulo"), ("Linha", "linha"), ("Rabisco", "rabisco")]:
    ...
    def _criar_canvas(self, root, ao_clicar, ao_arrastar, ao_soltar):
